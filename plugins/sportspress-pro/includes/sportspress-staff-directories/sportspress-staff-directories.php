...
class SportsPress_Staff_Directories {
	...
	public function __construct() {
		...
		// Add the staff_contacts template to player_profile shortcode output.
		add_action( 'sp_staff_profile_after_templates', array( $this, 'output_staff_contacts' ) );
	...
	*/
	 ...
	 * @return void
	 */
	public function output_staff_contacts( $atts = array() ) {
		if ( empty( $atts ) ) {
